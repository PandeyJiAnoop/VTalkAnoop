...
//import com.akp.vtalkanoop.agora_videoaudiocall.AgoraActivity;
...
public class AstroDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("type","ASTROLOGER");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://vtalklive.com/api/Vtalk/UserList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(AstroDetails.this, 2);
                    AstroAdapter walletHistoryAdapter = new AstroAdapter(AstroDetails.this, arrayList);
