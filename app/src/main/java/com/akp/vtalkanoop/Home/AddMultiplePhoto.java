...
public class AddMultiplePhoto extends AppCompatActivity {
    AppCompatButton select, previous, next;
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (position < mArrayUri.size() - 1) {
                    ...
                    Toast.makeText(getApplicationContext(), "Last Image Already Shown", Toast.LENGTH_SHORT).show();
                }
            }
        });
