...
public class AVideoCallActivity extends AppCompatActivity {
    String callID,CallTime;
    String RecieverId,Rate,UserId;
    private SharedPreferences login_preference;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_a_video_call);
    ...
    public void addFragment() {
        ...
        ZegoUIKitPrebuiltCallFragment fragment = ZegoUIKitPrebuiltCallFragment.newInstance(appID, appSign, UserId,
                name, callID, config);
        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container1, fragment).commitNow();
...
//        Log.d("resp_data",appID+"\nappsignin:- "+appSign+"\nCallId:- "+callID+"\nUserId:- "+UserId+"\nName:- "+name+"\nCallID:- "+callID+"\nConfig:- "+config);
    ...
    protected void onDestroy() {
        ...
        CallingServiceAPI(callID,RecieverId,"Done","VideoCall",CallTime);
        super.onDestroy();
    }
    ...
    public  void  CallingServiceAPI(String caller_acountid,String reciever_accountid,String status,
        ...
        }, AVideoCallActivity.this, call1, "", true);
    }
