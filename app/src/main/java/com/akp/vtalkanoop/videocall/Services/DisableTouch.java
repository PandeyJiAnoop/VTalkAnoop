package com.akp.vtalkanoop.videocall.Services;
...
import static com.akp.vtalkanoop.videocall.Helpers.Constants.NOTIFICATION_CHANNEL_ID;
import static com.akp.vtalkanoop.videocall.Helpers.Constants.NOTIFICATION_CHANNEL_NAME;
...
public class DisableTouch extends Service implements View.OnClickListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent notificationIntent = new Intent(this, AstroProfile.class);
